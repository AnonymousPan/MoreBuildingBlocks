...
public class ItemRecordSenbonZakura extends ItemRecord {

	protected ItemRecordSenbonZakura() {
		super(MoreBuildingBlocks.MODID + ":" + recordTitle);
	}
	
	public static final String itemID = "itemRecordSenbonZakura";
	public static final String recordTitle = "SenbonZakura";
	public static final String fileName = "SenbonZakura";
	public static final Item item = new ItemRecordSenbonZakura();
